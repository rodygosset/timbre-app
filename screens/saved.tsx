...
const Saved = ({ onAudioPress }: Props) => {

    // retrieve the list of recordings from the context

    const { transformedRecordings } = useContext(Context)
    ...
    const getRecordingsByDate = (): ListOfRecordingsProps[] => {
        ...
        const sortedRecordings = transformedRecordings.sort((a, b) => b.date.getTime() - a.date.getTime())
    ...
    return (
        <ScreenContainer>
            ...
            <View style={styles.container}>
                ...
                {
                    transformedRecordings.length > 0 ?
                    <FlatList 
                        style={{ width: "100%" }}
                    ...
                    <View style={styles.empty}>
                        <Text style={styles.noRecordings}>No transformed recordings yet</Text>
                        <Text style={styles.noRecordingsCaption}>Go to the transform page to start !</Text>
                    </View>
